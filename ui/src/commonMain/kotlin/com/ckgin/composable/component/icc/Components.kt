...
import com.ckgin.composable.core.R
import com.ckgin.composable.core.component.BackgroundBox
import com.ckgin.composable.core.component.defaultContainerColor
import com.ckgin.composable.core.component.defaultShape
import com.ckgin.composable.core.component.defaultSurfaceColor
import com.ckgin.composable.core.theme.ComposablePreview
        ...
        LazyRow(
            ...
            items(
                ...
                Column(
                    ...
                    Text(
                        text = item.second.toString().padStart(2, '0'),
...
fun HeartButtonComponent(modifier: Modifier = Modifier) {
    BackgroundBox(modifier = modifier) {
                ...
                burstHeart.forEach { heart ->
                    Icon(
                        ...
                        modifier = Modifier
                            .offset {
                                IntOffset(
                                    x = (heart.distance * progress * cos(heart.angle * PI.toFloat() / 180f)).toInt(),
                                    y = (heart.distance * progress * sin(heart.angle * PI.toFloat() / 180f)).toInt()
                                )
                            }
                            .alpha(alpha)
                            .size(20.dp)
        ...
        // Main heart
        Icon(
            painter = painterResource(if (isLiked) R.drawable.heart_filled else R.drawable.heart_unfilled),
